...
export class ApiHealthDetailedGet200Response {
    /**
    ...
    */
    'version'?: string;
    'services'?: ApiHealthDetailedGet200ResponseServices;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "services",
            "baseName": "services",
            "type": "ApiHealthDetailedGet200ResponseServices",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiHealthDetailedGet200Response.attributeTypeMap;
    }
