...
export class ApiAdminCompetitionCompetitionIdSnapshotsGet200Response {
    /**
    * Operation success status
    */
    'success'?: boolean;
    'snapshots'?: Array<ApiAdminCompetitionCompetitionIdSnapshotsGet200ResponseSnapshotsInner>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "snapshots",
            "baseName": "snapshots",
            "type": "Array<ApiAdminCompetitionCompetitionIdSnapshotsGet200ResponseSnapshotsInner>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiAdminCompetitionCompetitionIdSnapshotsGet200Response.attributeTypeMap;
    }
