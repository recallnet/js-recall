...
export class ApiPublicTeamsRegisterPost201Response {
    /**
    * Operation success status
    */
    'success'?: boolean;
    'team'?: ApiPublicTeamsRegisterPost201ResponseTeam;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "team",
            "baseName": "team",
            "type": "ApiPublicTeamsRegisterPost201ResponseTeam",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiPublicTeamsRegisterPost201Response.attributeTypeMap;
    }
