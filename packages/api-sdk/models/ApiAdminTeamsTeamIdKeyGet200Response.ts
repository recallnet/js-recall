...
export class ApiAdminTeamsTeamIdKeyGet200Response {
    /**
    * Operation success status
    */
    'success'?: boolean;
    'team'?: ApiAdminTeamsTeamIdKeyGet200ResponseTeam;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "team",
            "baseName": "team",
            "type": "ApiAdminTeamsTeamIdKeyGet200ResponseTeam",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiAdminTeamsTeamIdKeyGet200Response.attributeTypeMap;
    }
