...
export class ApiAdminTeamsTeamIdDeactivatePost200Response {
    /**
    * Operation success status
    */
    'success'?: boolean;
    'team'?: ApiAdminTeamsTeamIdDeactivatePost200ResponseTeam;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "team",
            "baseName": "team",
            "type": "ApiAdminTeamsTeamIdDeactivatePost200ResponseTeam",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiAdminTeamsTeamIdDeactivatePost200Response.attributeTypeMap;
    }
