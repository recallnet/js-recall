...
export class ApiAccountBalancesGet200Response {
    /**
    ...
    */
    'teamId'?: string;
    'balances'?: Array<ApiAccountBalancesGet200ResponseBalancesInner>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "balances",
            "baseName": "balances",
            "type": "Array<ApiAccountBalancesGet200ResponseBalancesInner>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiAccountBalancesGet200Response.attributeTypeMap;
    }
