...
export class ApiAdminReportsPerformanceGet200ResponseCompetition {
    /**
    * Competition ID
    */
    'id'?: string;
    ...
    * Competition status
    */
    'status'?: ApiAdminReportsPerformanceGet200ResponseCompetitionStatusEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "ApiAdminReportsPerformanceGet200ResponseCompetitionStatusEnum",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return ApiAdminReportsPerformanceGet200ResponseCompetition.attributeTypeMap;
    }
...
export enum ApiAdminReportsPerformanceGet200ResponseCompetitionStatusEnum {
    Pending = 'PENDING',
    Active = 'ACTIVE',
    Completed = 'COMPLETED'
}
