...
export class ApiTradeExecutePost200Response {
    /**
    * Whether the trade was successfully executed
    */
    'success'?: boolean;
    'transaction'?: ApiAccountTradesGet200ResponseTradesInner;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "ApiAccountTradesGet200ResponseTradesInner",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiTradeExecutePost200Response.attributeTypeMap;
    }
