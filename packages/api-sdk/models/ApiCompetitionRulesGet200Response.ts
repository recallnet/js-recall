...
export class ApiCompetitionRulesGet200Response {
    /**
    * Operation success status
    */
    'success'?: boolean;
    'rules'?: ApiCompetitionRulesGet200ResponseRules;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "rules",
            "baseName": "rules",
            "type": "ApiCompetitionRulesGet200ResponseRules",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiCompetitionRulesGet200Response.attributeTypeMap;
    }
