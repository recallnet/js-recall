...
export class ApiAdminCompetitionStartPost200Response {
    /**
    * Operation success status
    */
    'success'?: boolean;
    'competition'?: ApiAdminCompetitionStartPost200ResponseCompetition;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "ApiAdminCompetitionStartPost200ResponseCompetition",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiAdminCompetitionStartPost200Response.attributeTypeMap;
    }
