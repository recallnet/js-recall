...
export class ApiAccountTradesGet200Response {
    /**
    ...
    */
    'teamId'?: string;
    'trades'?: Array<ApiAccountTradesGet200ResponseTradesInner>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "trades",
            "baseName": "trades",
            "type": "Array<ApiAccountTradesGet200ResponseTradesInner>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiAccountTradesGet200Response.attributeTypeMap;
    }
