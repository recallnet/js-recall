...
export class ApiCompetitionStatusGet200ResponseCompetition {
    /**
    * Competition ID
    */
    'id'?: string;
    ...
    * Competition status
    */
    'status'?: ApiCompetitionStatusGet200ResponseCompetitionStatusEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "ApiCompetitionStatusGet200ResponseCompetitionStatusEnum",
            "format": ""
        },
        {
            "name": "createdAt",
    ...
    static getAttributeTypeMap() {
        return ApiCompetitionStatusGet200ResponseCompetition.attributeTypeMap;
    }
...
export enum ApiCompetitionStatusGet200ResponseCompetitionStatusEnum {
    Pending = 'PENDING',
    Active = 'ACTIVE',
    Completed = 'COMPLETED'
}
