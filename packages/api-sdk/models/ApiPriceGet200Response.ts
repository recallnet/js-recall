...
export class ApiPriceGet200Response {
    /**
    ...
    */
    'chain'?: ApiPriceGet200ResponseChainEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "chain",
            "baseName": "chain",
            "type": "ApiPriceGet200ResponseChainEnum",
            "format": ""
        },
        {
            "name": "specificChain",
    ...
    static getAttributeTypeMap() {
        return ApiPriceGet200Response.attributeTypeMap;
    }
...
export enum ApiPriceGet200ResponseChainEnum {
    Evm = 'EVM',
    Svm = 'SVM'
}
