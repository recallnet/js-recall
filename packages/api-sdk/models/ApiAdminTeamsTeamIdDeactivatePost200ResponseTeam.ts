...
export class ApiAdminTeamsTeamIdDeactivatePost200ResponseTeam {
    /**
    * Team ID
    */
    'id'?: string;
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "baseName": "deactivationReason",
            "type": "string",
            "format": ""
        },
        {
            "name": "deactivationDate",
            "baseName": "deactivationDate",
            "type": "Date",
            "format": "date-time"
        }    ];

    static getAttributeTypeMap() {
        return ApiAdminTeamsTeamIdDeactivatePost200ResponseTeam.attributeTypeMap;
    }
