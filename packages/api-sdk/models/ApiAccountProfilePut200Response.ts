...
export class ApiAccountProfilePut200Response {
    /**
    * Operation success status
    */
    'success'?: boolean;
    'team'?: ApiAccountProfilePut200ResponseTeam;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "team",
            "baseName": "team",
            "type": "ApiAccountProfilePut200ResponseTeam",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiAccountProfilePut200Response.attributeTypeMap;
    }
