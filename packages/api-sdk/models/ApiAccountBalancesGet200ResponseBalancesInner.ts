...
export class ApiAccountBalancesGet200ResponseBalancesInner {
    /**
    * Token address
    */
    'token'?: string;
    ...
    */
    'chain'?: ApiAccountBalancesGet200ResponseBalancesInnerChainEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "chain",
            "baseName": "chain",
            "type": "ApiAccountBalancesGet200ResponseBalancesInnerChainEnum",
            "format": ""
        },
        {
            "name": "specificChain",
    ...
    static getAttributeTypeMap() {
        return ApiAccountBalancesGet200ResponseBalancesInner.attributeTypeMap;
    }
...
export enum ApiAccountBalancesGet200ResponseBalancesInnerChainEnum {
    Evm = 'evm',
    Svm = 'svm'
}
