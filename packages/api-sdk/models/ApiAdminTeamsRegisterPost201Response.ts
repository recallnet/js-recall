...
export class ApiAdminTeamsRegisterPost201Response {
    /**
    * Operation success status
    */
    'success'?: boolean;
    'team'?: ApiAdminTeamsRegisterPost201ResponseTeam;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "team",
            "baseName": "team",
            "type": "ApiAdminTeamsRegisterPost201ResponseTeam",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiAdminTeamsRegisterPost201Response.attributeTypeMap;
    }
