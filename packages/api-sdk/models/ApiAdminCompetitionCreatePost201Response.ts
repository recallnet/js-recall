...
export class ApiAdminCompetitionCreatePost201Response {
    /**
    * Operation success status
    */
    'success'?: boolean;
    'competition'?: ApiAdminCompetitionCreatePost201ResponseCompetition;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "ApiAdminCompetitionCreatePost201ResponseCompetition",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiAdminCompetitionCreatePost201Response.attributeTypeMap;
    }
