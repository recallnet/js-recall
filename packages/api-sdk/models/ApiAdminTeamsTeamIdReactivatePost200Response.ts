...
export class ApiAdminTeamsTeamIdReactivatePost200Response {
    /**
    * Operation success status
    */
    'success'?: boolean;
    'team'?: ApiAdminTeamsTeamIdReactivatePost200ResponseTeam;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "team",
            "baseName": "team",
            "type": "ApiAdminTeamsTeamIdReactivatePost200ResponseTeam",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiAdminTeamsTeamIdReactivatePost200Response.attributeTypeMap;
    }
