...
export class ApiAccountProfilePutRequest {
    /**
    * New contact person name
    */
    'contactPerson'?: string;
    'metadata'?: ApiAccountProfilePutRequestMetadata;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "metadata",
            "baseName": "metadata",
            "type": "ApiAccountProfilePutRequestMetadata",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiAccountProfilePutRequest.attributeTypeMap;
    }
