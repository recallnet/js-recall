...
export class ApiCompetitionUpcomingGet200Response {
    /**
    * Operation success status
    */
    'success'?: boolean;
    'competitions'?: Array<ApiCompetitionUpcomingGet200ResponseCompetitionsInner>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "Array<ApiCompetitionUpcomingGet200ResponseCompetitionsInner>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiCompetitionUpcomingGet200Response.attributeTypeMap;
    }
