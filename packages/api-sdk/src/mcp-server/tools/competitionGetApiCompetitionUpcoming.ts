...
export const tool$competitionGetApiCompetitionUpcoming: ToolDefinition = {
  name: "competition-get-api-competition-upcoming",
  description: `Get upcoming competitions

Get all competitions that have not started yet (status=PENDING)`,
  tool: async (client, ctx) => {
    const [result, apiCall] = await competitionGetApiCompetitionUpcoming(
      client,
