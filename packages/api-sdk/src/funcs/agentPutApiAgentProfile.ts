 ...
 */
export function agentPutApiAgentProfile(
  client: ApiSDKCore,
  request: operations.PutApiAgentProfileRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PutApiAgentProfileResponse,
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PutApiAgentProfileRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/agent/profile")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.PutApiAgentProfileResponse$inboundSchema),
