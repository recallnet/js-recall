...
export function competitionGetApiCompetitionsLeaderboard(
  ...
  Result<
    operations.GetApiCompetitionsLeaderboardResponse,
    | APISDKError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetApiCompetitionsLeaderboardRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/api/competitions/leaderboard")();
  ...
  const context = {
    ...
    operationID: "get_/api/competitions/leaderboard",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetApiCompetitionsLeaderboardResponse$inboundSchema),
