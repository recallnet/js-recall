 ...
 */
export function userPostApiUserVerifyEmail(
  client: ApiSDKCore,
  security: operations.PostApiUserVerifyEmailSecurity,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PostApiUserVerifyEmailResponse,
    | errors.PostApiUserVerifyEmailBadRequestError
    | APISDKError
...
> {
  const path = pathToFunc("/api/user/verify-email")();
  ...
  const context = {
    ...
    operationID: "post_/api/user/verify-email",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.PostApiUserVerifyEmailResponse$inboundSchema),
    M.jsonErr(400, errors.PostApiUserVerifyEmailBadRequestError$inboundSchema),
    M.fail([401, 404, "4XX"]),
    M.fail([500, "5XX"]),
