...
export function competitionGetApiCompetitionsCompetitionIdAgents(
  ...
  Result<
    operations.GetApiCompetitionsCompetitionIdAgentsResponse,
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetApiCompetitionsCompetitionIdAgentsRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/api/competitions/{competitionId}/agents")(
    pathParams,
  );
  ...
  const context = {
    ...
    operationID: "get_/api/competitions/{competitionId}/agents",
    oAuth2Scopes: [],
  ...
  >(
    M.json(
      200,
      operations.GetApiCompetitionsCompetitionIdAgentsResponse$inboundSchema,
    ),
