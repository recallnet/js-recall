 ...
 */
export function authPostApiAuthVerify(
  client: ApiSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PostApiAuthVerifyRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/auth/verify")();
  ...
  const context = {
    ...
    operationID: "post_/api/auth/verify",
    oAuth2Scopes: null,
