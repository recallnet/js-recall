 ...
 */
export function userPutApiUserProfile(
  client: ApiSDKCore,
  ...
  Result<
    operations.PutApiUserProfileResponse,
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PutApiUserProfileRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/user/profile")();
  ...
  const context = {
    ...
    operationID: "put_/api/user/profile",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.PutApiUserProfileResponse$inboundSchema),
