 ...
 */
export function adminPutApiAdminAgentsAgentId(
  client: ApiSDKCore,
  request: operations.PutApiAdminAgentsAgentIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PutApiAdminAgentsAgentIdResponse,
    | APISDKError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PutApiAdminAgentsAgentIdRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "put_/api/admin/agents/{agentId}",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.PutApiAdminAgentsAgentIdResponse$inboundSchema),
