...
export function competitionDeleteApiCompetitionsCompetitionIdAgentsAgentId(
  ...
  Result<
    operations.DeleteApiCompetitionsCompetitionIdAgentsAgentIdResponse,
    | APISDKError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteApiCompetitionsCompetitionIdAgentsAgentIdRequest$outboundSchema.parse(
        value,
      ),
  ...
  const context = {
    ...
    operationID: "delete_/api/competitions/{competitionId}/agents/{agentId}",
    oAuth2Scopes: [],
  ...
  >(
    M.json(
      200,
      operations.DeleteApiCompetitionsCompetitionIdAgentsAgentIdResponse$inboundSchema,
    ),
