 ...
 */
export function adminPostApiAdminCompetitionsCompetitionIdAgentsAgentId(
  client: ApiSDKCore,
  request: operations.PostApiAdminCompetitionsCompetitionIdAgentsAgentIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PostApiAdminCompetitionsCompetitionIdAgentsAgentIdResponse,
    | APISDKError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostApiAdminCompetitionsCompetitionIdAgentsAgentIdRequest$outboundSchema.parse(
        value,
      ),
  ...
  const context = {
    ...
    operationID:
      "post_/api/admin/competitions/{competitionId}/agents/{agentId}",
    oAuth2Scopes: [],
  ...
  >(
    M.json(
      200,
      operations.PostApiAdminCompetitionsCompetitionIdAgentsAgentIdResponse$inboundSchema,
    ),
