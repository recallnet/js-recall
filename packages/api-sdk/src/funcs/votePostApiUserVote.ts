 ...
 */
export function votePostApiUserVote(
  client: ApiSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PostApiUserVoteRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/user/vote")();
  ...
  const context = {
    ...
    operationID: "post_/api/user/vote",
    oAuth2Scopes: null,
