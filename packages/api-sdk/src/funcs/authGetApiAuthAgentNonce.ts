 ...
 */
export function authGetApiAuthAgentNonce(
  client: ApiSDKCore,
...
> {
  const path = pathToFunc("/api/auth/agent/nonce")();
  ...
  const context = {
    ...
    operationID: "get_/api/auth/agent/nonce",
    oAuth2Scopes: null,
  ...
  >(
    ...
    M.jsonErr(
      500,
      errors.GetApiAuthAgentNonceInternalServerError$inboundSchema,
    ),
    M.fail([401, "4XX"]),
    M.fail("5XX"),
