 ...
 */
export function adminPostApiAdminAgents(
  client: ApiSDKCore,
  request: operations.PostApiAdminAgentsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PostApiAdminAgentsResponse,
    | APISDKError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PostApiAdminAgentsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/admin/agents")();
  ...
  const context = {
    ...
    operationID: "post_/api/admin/agents",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.PostApiAdminAgentsResponse$inboundSchema),
