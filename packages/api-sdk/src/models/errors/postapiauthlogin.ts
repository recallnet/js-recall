 ...
 * Internal server error
 */
export class PostApiAuthLoginInternalServerError extends Error {
  error?: string | undefined;

  /** The original data that was passed to this error instance. */
  data$: PostApiAuthLoginInternalServerErrorData;

  constructor(err: PostApiAuthLoginInternalServerErrorData) {
...
export const PostApiAuthLoginInternalServerError$outboundSchema: z.ZodType<
  ...
  z.ZodTypeDef,
  PostApiAuthLoginInternalServerError
> = z.instanceof(PostApiAuthLoginInternalServerError)
  .transform(v => v.data$)
  .pipe(z.object({
    error: z.string().optional(),
  }));
