...
/** @internal */
export const GetApiCompetitionsStatusCrossChainTradingType$inboundSchema:
  z.ZodNativeEnum<typeof GetApiCompetitionsStatusCrossChainTradingType> = z
    .nativeEnum(GetApiCompetitionsStatusCrossChainTradingType);

/** @internal */
export const GetApiCompetitionsStatusCrossChainTradingType$outboundSchema:
  z.ZodNativeEnum<typeof GetApiCompetitionsStatusCrossChainTradingType> =
...
> = z.object({
  ...
  competition: z.nullable(
    z.lazy(() => GetApiCompetitionsStatusCompetition$inboundSchema),
  ).optional(),
...
> = z.object({
  ...
  active: z.boolean().optional(),
  competition: z.nullable(
    z.lazy(() => GetApiCompetitionsStatusCompetition$outboundSchema),
  ).optional(),
  message: z.nullable(z.string()).optional(),
  participating: z.nullable(z.boolean()).optional(),
});
