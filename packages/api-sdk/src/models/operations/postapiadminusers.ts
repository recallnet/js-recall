...
> = z.object({
  ...
  imageUrl: z.nullable(z.string()).optional(),
  metadata: z.nullable(
    z.lazy(() => PostApiAdminUsersAgentMetadata$inboundSchema),
  ).optional(),
...
> = z.object({
  ...
  imageUrl: z.nullable(z.string()).optional(),
  metadata: z.nullable(
    z.lazy(() => PostApiAdminUsersAgentMetadata$outboundSchema),
  ).optional(),
  apiKey: z.string().optional(),
  status: z.string().optional(),
  createdAt: z.date().transform(v => v.toISOString()).optional(),
...
> = z.object({
  ...
  agent: z.nullable(z.lazy(() => PostApiAdminUsersAgent$inboundSchema))
    .optional(),
...
> = z.object({
  ...
  agent: z.nullable(z.lazy(() => PostApiAdminUsersAgent$outboundSchema))
    .optional(),
  agentError: z.nullable(z.string()).optional(),
});
