...
/** @internal */
export const GetApiCompetitionUpcomingCrossChainTradingType$inboundSchema:
  z.ZodNativeEnum<typeof GetApiCompetitionUpcomingCrossChainTradingType> = z
    .nativeEnum(GetApiCompetitionUpcomingCrossChainTradingType);

/** @internal */
export const GetApiCompetitionUpcomingCrossChainTradingType$outboundSchema:
  z.ZodNativeEnum<typeof GetApiCompetitionUpcomingCrossChainTradingType> =
...
> = z.object({
  ...
  competitions: z.array(
    z.lazy(() => GetApiCompetitionUpcomingCompetition$inboundSchema),
  ).optional(),
});
...
> = z.object({
  success: z.boolean().optional(),
  competitions: z.array(
    z.lazy(() => GetApiCompetitionUpcomingCompetition$outboundSchema),
  ).optional(),
});
