...
> = z.object({
  ...
  email: z.nullable(z.string()).optional(),
  metadata: z.nullable(z.lazy(() => GetApiAdminSearchMetadata$inboundSchema))
    .optional(),
  status: z.string().optional(),
  imageUrl: z.nullable(z.string()).optional(),
  createdAt: z.string().datetime({ offset: true }).transform(v => new Date(v))
...
> = z.object({
  ...
  description: z.nullable(z.string()).optional(),
  email: z.nullable(z.string()).optional(),
  metadata: z.nullable(z.lazy(() => GetApiAdminSearchMetadata$outboundSchema))
    .optional(),
  status: z.string().optional(),
  imageUrl: z.nullable(z.string()).optional(),
  createdAt: z.date().transform(v => v.toISOString()).optional(),
...
export const Results$inboundSchema: z.ZodType<Results, z.ZodTypeDef, unknown> =
  z.object({
    users: z.array(z.lazy(() => GetApiAdminSearchUser$inboundSchema))
      .optional(),
    agents: z.array(z.lazy(() => GetApiAdminSearchAgent$inboundSchema))
      .optional(),
  });
...
> = z.object({
  ...
  agents: z.array(z.lazy(() => GetApiAdminSearchAgent$outboundSchema))
    .optional(),
});
