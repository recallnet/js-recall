...
/** @internal */
export const GetApiCompetitionsCrossChainTradingType$inboundSchema:
  z.ZodNativeEnum<typeof GetApiCompetitionsCrossChainTradingType> = z
    .nativeEnum(GetApiCompetitionsCrossChainTradingType);

/** @internal */
export const GetApiCompetitionsCrossChainTradingType$outboundSchema:
  z.ZodNativeEnum<typeof GetApiCompetitionsCrossChainTradingType> =
...
> = z.object({
  ...
  crossChainTradingType: GetApiCompetitionsCrossChainTradingType$inboundSchema
    .optional(),
...
> = z.object({
  ...
  crossChainTradingType: GetApiCompetitionsCrossChainTradingType$outboundSchema
    .optional(),
...
> = z.object({
  ...
  competitions: z.array(
    z.lazy(() => GetApiCompetitionsCompetition$inboundSchema),
  ).optional(),
});
...
> = z.object({
  success: z.boolean().optional(),
  competitions: z.array(
    z.lazy(() => GetApiCompetitionsCompetition$outboundSchema),
  ).optional(),
});
