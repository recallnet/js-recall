...
/** @internal */
export const PostApiAdminCompetitionStartTradingType$inboundSchema:
  z.ZodNativeEnum<typeof PostApiAdminCompetitionStartTradingType> = z
    .nativeEnum(PostApiAdminCompetitionStartTradingType);

/** @internal */
export const PostApiAdminCompetitionStartTradingType$outboundSchema:
  z.ZodNativeEnum<typeof PostApiAdminCompetitionStartTradingType> =
...
/** @internal */
export const PostApiAdminCompetitionStartTypeRequest$inboundSchema:
  z.ZodNativeEnum<typeof PostApiAdminCompetitionStartTypeRequest> = z
    .nativeEnum(PostApiAdminCompetitionStartTypeRequest);

/** @internal */
export const PostApiAdminCompetitionStartTypeRequest$outboundSchema:
  z.ZodNativeEnum<typeof PostApiAdminCompetitionStartTypeRequest> =
...
> = z.object({
  ...
  tradingType: PostApiAdminCompetitionStartTradingType$inboundSchema.default(
    "disallowAll",
  ),
...
> = z.object({
  ...
  imageUrl: z.string().optional(),
  agentIds: z.array(z.string()),
  tradingType: PostApiAdminCompetitionStartTradingType$outboundSchema.default(
    "disallowAll",
  ),
...
/** @internal */
export const PostApiAdminCompetitionStartCrossChainTradingType$inboundSchema:
  z.ZodNativeEnum<typeof PostApiAdminCompetitionStartCrossChainTradingType> = z
    .nativeEnum(PostApiAdminCompetitionStartCrossChainTradingType);

/** @internal */
export const PostApiAdminCompetitionStartCrossChainTradingType$outboundSchema:
  z.ZodNativeEnum<typeof PostApiAdminCompetitionStartCrossChainTradingType> =
...
/** @internal */
export const PostApiAdminCompetitionStartTypeResponse$inboundSchema:
  z.ZodNativeEnum<typeof PostApiAdminCompetitionStartTypeResponse> = z
    .nativeEnum(PostApiAdminCompetitionStartTypeResponse);

/** @internal */
export const PostApiAdminCompetitionStartTypeResponse$outboundSchema:
  z.ZodNativeEnum<typeof PostApiAdminCompetitionStartTypeResponse> =
