...
/** @internal */
export const GetApiCompetitionsCompetitionIdStatus$inboundSchema:
  z.ZodNativeEnum<typeof GetApiCompetitionsCompetitionIdStatus> = z.nativeEnum(
    GetApiCompetitionsCompetitionIdStatus,
  );

/** @internal */
export const GetApiCompetitionsCompetitionIdStatus$outboundSchema:
  z.ZodNativeEnum<typeof GetApiCompetitionsCompetitionIdStatus> =
...
/** @internal */
export const GetApiCompetitionsCompetitionIdCrossChainTradingType$inboundSchema:
  z.ZodNativeEnum<typeof GetApiCompetitionsCompetitionIdCrossChainTradingType> =
    z.nativeEnum(GetApiCompetitionsCompetitionIdCrossChainTradingType);

/** @internal */
export const GetApiCompetitionsCompetitionIdCrossChainTradingType$outboundSchema:
  z.ZodNativeEnum<typeof GetApiCompetitionsCompetitionIdCrossChainTradingType> =
...
/** @internal */
export const GetApiCompetitionsCompetitionIdCompetition$inboundSchema:
  z.ZodType<GetApiCompetitionsCompetitionIdCompetition, z.ZodTypeDef, unknown> =
    z.object({
...
/** @internal */
export const GetApiCompetitionsCompetitionIdCompetition$outboundSchema:
  z.ZodType<
