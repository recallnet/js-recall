...
/** @internal */
export const GetApiCompetitionStatusCrossChainTradingType$inboundSchema:
  z.ZodNativeEnum<typeof GetApiCompetitionStatusCrossChainTradingType> = z
    .nativeEnum(GetApiCompetitionStatusCrossChainTradingType);

/** @internal */
export const GetApiCompetitionStatusCrossChainTradingType$outboundSchema:
  z.ZodNativeEnum<typeof GetApiCompetitionStatusCrossChainTradingType> =
...
> = z.object({
  ...
  competition: z.nullable(
    z.lazy(() => GetApiCompetitionStatusCompetition$inboundSchema),
  ).optional(),
...
> = z.object({
  ...
  active: z.boolean().optional(),
  competition: z.nullable(
    z.lazy(() => GetApiCompetitionStatusCompetition$outboundSchema),
  ).optional(),
  message: z.nullable(z.string()).optional(),
  participating: z.nullable(z.boolean()).optional(),
});
