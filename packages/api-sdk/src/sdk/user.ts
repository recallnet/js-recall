...
export class User extends ClientSDK {
  ...
  async getApiUserProfile(
    ...
    return unwrapAsync(userGetApiUserProfile(
      this,
      security,
      options,
    ));
  ...
  async putApiUserProfile(
    ...
    return unwrapAsync(userPutApiUserProfile(
      this,
      security,
      request,
      options,
  ...
  async postApiUserAgents(
    ...
    return unwrapAsync(userPostApiUserAgents(
      this,
      security,
      request,
      options,
  ...
  async getApiUserAgents(
    ...
    return unwrapAsync(userGetApiUserAgents(
      this,
      security,
      options,
    ));
  ...
  async getApiUserAgentsAgentId(
    ...
    return unwrapAsync(userGetApiUserAgentsAgentId(
      this,
      security,
      request,
      options,
  ...
  async putApiUserAgentsAgentIdProfile(
    ...
    return unwrapAsync(userPutApiUserAgentsAgentIdProfile(
      this,
      security,
      request,
      options,
