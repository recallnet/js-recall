...
export class Account extends ClientSDK {
  ...
  async getApiAccountProfile(
    ...
    return unwrapAsync(accountGetApiAccountProfile(
      this,
      options,
    ));
  }
  ...
  async putApiAccountProfile(
    ...
    return unwrapAsync(accountPutApiAccountProfile(
      this,
      request,
      options,
    ));
  ...
  async postApiAccountResetApiKey(
    ...
    return unwrapAsync(accountPostApiAccountResetApiKey(
      this,
      options,
    ));
  }
  ...
  async getApiAccountBalances(
    ...
    return unwrapAsync(accountGetApiAccountBalances(
      this,
      options,
    ));
  }
