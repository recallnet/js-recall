...
export class Admin extends ClientSDK {
  ...
  async postApiAdminUsers(
    ...
    return unwrapAsync(adminPostApiAdminUsers(
      this,
      request,
      options,
    ));
  ...
  async getApiAdminUsers(
    ...
    return unwrapAsync(adminGetApiAdminUsers(
      this,
      options,
    ));
  }
  ...
  async getApiAdminAgents(
    ...
    return unwrapAsync(adminGetApiAdminAgents(
      this,
      options,
    ));
  }
  ...
  async getApiAdminAgentsAgentIdKey(
    ...
    return unwrapAsync(adminGetApiAdminAgentsAgentIdKey(
      this,
      request,
      options,
    ));
  ...
  async deleteApiAdminAgentsAgentId(
    ...
    return unwrapAsync(adminDeleteApiAdminAgentsAgentId(
      this,
      request,
      options,
    ));
  ...
  async getApiAdminAgentsAgentId(
    ...
    return unwrapAsync(adminGetApiAdminAgentsAgentId(
      this,
      request,
      options,
    ));
  ...
  async postApiAdminAgentsAgentIdDeactivate(
    ...
    return unwrapAsync(adminPostApiAdminAgentsAgentIdDeactivate(
      this,
      request,
      options,
    ));
  ...
  async postApiAdminAgentsAgentIdReactivate(
    ...
    return unwrapAsync(adminPostApiAdminAgentsAgentIdReactivate(
      this,
      request,
      options,
    ));
  ...
  async getApiAdminSearch(
    ...
    return unwrapAsync(adminGetApiAdminSearch(
      this,
      request,
      options,
    ));
