...
export class Competition extends ClientSDK {
  ...
  async getApiCompetitionLeaderboard(
    ...
    return unwrapAsync(competitionGetApiCompetitionLeaderboard(
      this,
      request,
      options,
    ));
  ...
  async getApiCompetitionStatus(
    ...
    return unwrapAsync(competitionGetApiCompetitionStatus(
      this,
      options,
    ));
  }
  ...
  async getApiCompetitionRules(
    ...
    return unwrapAsync(competitionGetApiCompetitionRules(
      this,
      options,
    ));
  }
  ...
  async getApiCompetitionUpcoming(
    ...
    return unwrapAsync(competitionGetApiCompetitionUpcoming(
      this,
      options,
    ));
  }
