...
export class Competition extends ClientSDK {
  ...
  async getApiCompetitions(
    ...
    return unwrapAsync(competitionGetApiCompetitions(
      this,
      request,
      options,
    ));
  ...
  async getApiCompetitionsLeaderboard(
    ...
    return unwrapAsync(competitionGetApiCompetitionsLeaderboard(
      this,
      request,
      options,
    ));
  ...
  async getApiCompetitionsStatus(
    ...
    return unwrapAsync(competitionGetApiCompetitionsStatus(
      this,
      options,
    ));
  }
  ...
  async getApiCompetitionsRules(
    ...
    return unwrapAsync(competitionGetApiCompetitionsRules(
      this,
      options,
    ));
  }
  ...
  async getApiCompetitionsUpcoming(
    ...
    return unwrapAsync(competitionGetApiCompetitionsUpcoming(
      this,
      options,
    ));
  }
  ...
  async getApiCompetitionsCompetitionId(
    ...
    return unwrapAsync(competitionGetApiCompetitionsCompetitionId(
      this,
      request,
      options,
    ));
  ...
  async getApiCompetitionsCompetitionIdAgents(
    ...
    return unwrapAsync(competitionGetApiCompetitionsCompetitionIdAgents(
      this,
      request,
      options,
    ));
