...
export interface Env {
  RECALLCOMP_BEARER_AUTH?: string | undefined;

  RECALLCOMP_DEBUG?: boolean | undefined;
}

export const envSchema: z.ZodType<Env, z.ZodTypeDef, unknown> = z.object({
  RECALLCOMP_BEARER_AUTH: z.string().optional(),

  RECALLCOMP_DEBUG: z.coerce.boolean().optional(),
});
