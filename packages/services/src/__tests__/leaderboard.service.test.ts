...
describe("LeaderboardService", () => {
  ...
  beforeEach(() => {
    ...
    mockRepo = {
      ...
      getTotalActiveCompetitionAgents: vi.fn(),
  ...
  describe("getUnifiedLeaderboard", () => {
    ...
    describe("with benchmark and trading skills", () => {
      it("should combine benchmark models with trading agents correctly", async () => {
        ...
        mockRepo.getTotalActiveCompetitionAgents.mockResolvedValue(44);
        ...
        expect(mockRepo.getTotalActiveCompetitionAgents).toHaveBeenCalledTimes(
          1,
        );
      ...
      it("should handle perpetual futures skill correctly", async () => {
        ...
        mockRepo.getTotalActiveCompetitionAgents.mockResolvedValue(25);
      ...
      it("should handle both trading and futures skills together", async () => {
        ...
        mockRepo.getTotalActiveCompetitionAgents.mockResolvedValue(69);
    ...
    describe("edge cases", () => {
      it("should handle empty agent responses gracefully", async () => {
        ...
        mockRepo.getTotalActiveCompetitionAgents.mockResolvedValue(0);
    ...
    describe("data consistency", () => {
      it("should use stats from ALL agents, not just paginated results", async () => {
        ...
        mockRepo.getTotalActiveCompetitionAgents.mockResolvedValue(500);
