...
export interface DiamondLoupeFacetInterface extends Interface {
    getFunction(nameOrSignature: "facetAddress" | "facetAddresses" | "facetFunctionSelectors" | "facets" | "supportsInterface"): FunctionFragment;
...
export interface DiamondLoupeFacet extends BaseContract {
    ...
    getFunction(nameOrSignature: "facets"): TypedContractMethod<[], [IDiamondLoupe.FacetStructOutput[]], "view">;
