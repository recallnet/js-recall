...
export interface RegisterSubnetFacetInterface extends Interface {
    ...
    encodeFunctionData(functionFragment: "newSubnetActor", values: [SubnetActorDiamond.ConstructorParamsStruct]): string;
    decodeFunctionResult(functionFragment: "newSubnetActor", data: BytesLike): Result;
}
export declare namespace SubnetDeployedEvent {
    type InputTuple = [subnetAddr: AddressLike];
    type OutputTuple = [subnetAddr: string];
...
export interface RegisterSubnetFacet extends BaseContract {
    ...
    getFunction(nameOrSignature: "newSubnetActor"): TypedContractMethod<[
        _params: SubnetActorDiamond.ConstructorParamsStruct
    ], [
        string
    ], "nonpayable">;
    getEvent(key: "SubnetDeployed"): TypedContractEvent<SubnetDeployedEvent.InputTuple, SubnetDeployedEvent.OutputTuple, SubnetDeployedEvent.OutputObject>;
    filters: {
        "SubnetDeployed(address)": TypedContractEvent<SubnetDeployedEvent.InputTuple, SubnetDeployedEvent.OutputTuple, SubnetDeployedEvent.OutputObject>;
        SubnetDeployed: TypedContractEvent<SubnetDeployedEvent.InputTuple, SubnetDeployedEvent.OutputTuple, SubnetDeployedEvent.OutputObject>;
    };
}
//# sourceMappingURL=RegisterSubnetFacet.d.ts.map