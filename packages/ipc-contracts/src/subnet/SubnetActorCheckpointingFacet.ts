...
export interface SubnetActorCheckpointingFacetInterface extends Interface {
  getFunction(
    nameOrSignature: "submitCheckpoint" | "validateActiveQuorumSignatures"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    ...
    values: [BottomUpCheckpointStruct, AddressLike[], BytesLike[]]
  ): string;
  encodeFunctionData(
    functionFragment: "validateActiveQuorumSignatures",
...
export namespace ConfigurationNumberConfirmedEvent {
...
export namespace NewCollateralReleaseEvent {
  export type InputTuple = [
...
export interface SubnetActorCheckpointingFacet extends BaseContract {
  ...
  validateActiveQuorumSignatures: TypedContractMethod<
    [signatories: AddressLike[], hash: BytesLike, signatures: BytesLike[]],
    [void],
    "view"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "validateActiveQuorumSignatures"
  ): TypedContractMethod<
    [signatories: AddressLike[], hash: BytesLike, signatures: BytesLike[]],
    [void],
    "view"
  ...
  >;
  getEvent(
    key: "ConfigurationNumberConfirmed"
  ): TypedContractEvent<
    ConfigurationNumberConfirmedEvent.InputTuple,
    ConfigurationNumberConfirmedEvent.OutputTuple,
    ConfigurationNumberConfirmedEvent.OutputObject
  >;
  getEvent(
  ...
  >;
  getEvent(
    key: "NewCollateralRelease"
  ): TypedContractEvent<
    NewCollateralReleaseEvent.InputTuple,
    NewCollateralReleaseEvent.OutputTuple,
    NewCollateralReleaseEvent.OutputObject
  >;
  getEvent(
  ...
  filters: {
    ...
    "ConfigurationNumberConfirmed(uint64)": TypedContractEvent<
      ConfigurationNumberConfirmedEvent.InputTuple,
      ConfigurationNumberConfirmedEvent.OutputTuple,
      ConfigurationNumberConfirmedEvent.OutputObject
    >;
    ConfigurationNumberConfirmed: TypedContractEvent<
      ConfigurationNumberConfirmedEvent.InputTuple,
      ConfigurationNumberConfirmedEvent.OutputTuple,
      ConfigurationNumberConfirmedEvent.OutputObject
    >;
    ...
    "NewCollateralRelease(address,uint256,uint256)": TypedContractEvent<
      NewCollateralReleaseEvent.InputTuple,
      NewCollateralReleaseEvent.OutputTuple,
      NewCollateralReleaseEvent.OutputObject
    >;
    NewCollateralRelease: TypedContractEvent<
      NewCollateralReleaseEvent.InputTuple,
      NewCollateralReleaseEvent.OutputTuple,
      NewCollateralReleaseEvent.OutputObject
    >;
