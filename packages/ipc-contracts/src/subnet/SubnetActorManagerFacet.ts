...
export interface SubnetActorManagerFacetInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "addBootstrapNode",
    values: [string]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "preRelease",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "setFederatedPower",
...
export interface SubnetActorManagerFacet extends BaseContract {
  ...
  getFunction(
    nameOrSignature: "addBootstrapNode"
  ): TypedContractMethod<[netAddress: string], [void], "nonpayable">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "preFund"
  ): TypedContractMethod<[], [void], "payable">;
  getFunction(
    nameOrSignature: "preRelease"
  ): TypedContractMethod<[amount: BigNumberish], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "setFederatedPower"
  ): TypedContractMethod<
    [
      validators: AddressLike[],
      publicKeys: BytesLike[],
