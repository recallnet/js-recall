...
export interface GatewayManagerFacetInterface extends Interface {
    getFunction(nameOrSignature: "addStake" | "fund" | "fundWithToken" | "kill" | "register" | "release" | "releaseStake"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "fund", values: [SubnetIDStruct, FvmAddressStruct]): string;
    encodeFunctionData(functionFragment: "fundWithToken", values: [SubnetIDStruct, FvmAddressStruct, BigNumberish]): string;
    encodeFunctionData(functionFragment: "kill", values?: undefined): string;
    encodeFunctionData(functionFragment: "register", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "release", values: [FvmAddressStruct]): string;
    encodeFunctionData(functionFragment: "releaseStake", values: [BigNumberish]): string;
    decodeFunctionResult(functionFragment: "addStake", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "fund", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "fundWithToken", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "kill", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "register", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "release", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "releaseStake", data: BytesLike): Result;
}
...
export interface GatewayManagerFacet extends BaseContract {
    ...
    getFunction(nameOrSignature: "addStake"): TypedContractMethod<[], [void], "payable">;
    ...
    getFunction(nameOrSignature: "fundWithToken"): TypedContractMethod<[
        subnetId: SubnetIDStruct,
        to: FvmAddressStruct,
        amount: BigNumberish
    ], [
    ...
    getFunction(nameOrSignature: "register"): TypedContractMethod<[genesisCircSupply: BigNumberish], [void], "payable">;
    getFunction(nameOrSignature: "release"): TypedContractMethod<[to: FvmAddressStruct], [void], "payable">;
    getFunction(nameOrSignature: "releaseStake"): TypedContractMethod<[amount: BigNumberish], [void], "nonpayable">;
...
//# sourceMappingURL=GatewayManagerFacet.d.ts.map