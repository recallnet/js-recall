...
export interface CheckpointingFacetInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "addCheckpointSignature",
  ...
  encodeFunctionData(
    functionFragment: "pruneBottomUpCheckpoints",
    values: [BigNumberish]
  ): string;
...
export interface CheckpointingFacet extends BaseContract {
  ...
  getFunction(
    nameOrSignature: "addCheckpointSignature"
  ): TypedContractMethod<
    [
      height: BigNumberish,
      membershipProof: BytesLike[],
  ...
  >;
  getFunction(
    nameOrSignature: "pruneBottomUpCheckpoints"
  ): TypedContractMethod<
    [newRetentionHeight: BigNumberish],
    [void],
    "nonpayable"
