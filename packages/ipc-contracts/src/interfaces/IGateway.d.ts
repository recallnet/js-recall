...
export interface IGatewayInterface extends Interface {
    getFunction(nameOrSignature: "addStake" | "commitCheckpoint" | "commitParentFinality" | "createBottomUpCheckpoint" | "fund" | "fundWithToken" | "kill" | "propagate" | "register" | "release" | "releaseStake" | "sendContractXnetMessage"): FunctionFragment;
