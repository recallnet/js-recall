...
exports.SubnetActorDiamond__factory = void 0;
...
class SubnetActorDiamond__factory extends ethers_1.ContractFactory {
    constructor(...args) {
        if (isSuperArgs(args)) {
            ...
            super(_abi, SubnetActorDiamond__factory.linkBytecode(linkLibraryAddresses), signer);
        }
    }
    ...
    getDeployTransaction(_diamondCut, params, owner, overrides) {
        return super.getDeployTransaction(_diamondCut, params, owner, overrides || {});
    }
    deploy(_diamondCut, params, owner, overrides) {
        return super.deploy(_diamondCut, params, owner, overrides || {});
    }
    connect(runner) {
...
exports.SubnetActorDiamond__factory = SubnetActorDiamond__factory;
SubnetActorDiamond__factory.bytecode = _bytecode;
SubnetActorDiamond__factory.abi = _abi;
//# sourceMappingURL=SubnetActorDiamond__factory.js.map