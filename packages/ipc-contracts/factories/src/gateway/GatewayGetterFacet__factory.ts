...
import type {
  GatewayGetterFacet,
  GatewayGetterFacetInterface,
} from "../../../src/gateway/GatewayGetterFacet";
...
export class GatewayGetterFacet__factory extends ContractFactory {
  constructor(...args: GatewayGetterFacetConstructorParams) {
    if (isSuperArgs(args)) {
      ...
      super(
        _abi,
        GatewayGetterFacet__factory.linkBytecode(linkLibraryAddresses),
        signer
      );
    }
  }
  ...
  static linkBytecode(
    linkLibraryAddresses: GatewayGetterFacetLibraryAddresses
  ): string {
    ...
    linkedBytecode = linkedBytecode.replace(
      new RegExp("__\\$dd40c2ca5826d197ed7e2b6aae8146ec7b\\$__", "g"),
      linkLibraryAddresses["src/lib/LibQuorum.sol:LibQuorum"]
        .replace(/^0x/, "")
        .toLowerCase()
    );
  ...
  override connect(runner: ContractRunner | null): GatewayGetterFacet__factory {
    return super.connect(runner) as GatewayGetterFacet__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): GatewayGetterFacetInterface {
    return new Interface(_abi) as GatewayGetterFacetInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): GatewayGetterFacet {
    return new Contract(address, _abi, runner) as unknown as GatewayGetterFacet;
  }
}
