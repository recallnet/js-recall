...
exports.GatewayGetterFacet__factory = void 0;
...
class GatewayGetterFacet__factory extends ethers_1.ContractFactory {
    constructor(...args) {
        if (isSuperArgs(args)) {
            ...
            super(_abi, GatewayGetterFacet__factory.linkBytecode(linkLibraryAddresses), signer);
        }
    }
    static linkBytecode(linkLibraryAddresses) {
        ...
        linkedBytecode = linkedBytecode.replace(new RegExp("__\\$a0fe38a9a81205afccc10810b09a4d3f45\\$__", "g"), linkLibraryAddresses["src/lib/SubnetIDHelper.sol:SubnetIDHelper"]
            .replace(/^0x/, "")
            .toLowerCase());
        linkedBytecode = linkedBytecode.replace(new RegExp("__\\$dd40c2ca5826d197ed7e2b6aae8146ec7b\\$__", "g"), linkLibraryAddresses["src/lib/LibQuorum.sol:LibQuorum"]
            .replace(/^0x/, "")
            .toLowerCase());
...
exports.GatewayGetterFacet__factory = GatewayGetterFacet__factory;
GatewayGetterFacet__factory.bytecode = _bytecode;
GatewayGetterFacet__factory.abi = _abi;
//# sourceMappingURL=GatewayGetterFacet__factory.js.map