...
exports.CrossMsgHelper__factory = void 0;
...
const _abi = [
    {
        inputs: [],
        name: "CannotExecuteEmptyEnvelope",
        type: "error",
    },
    {
        inputs: [],
...
class CrossMsgHelper__factory extends ethers_1.ContractFactory {
    constructor(...args) {
        if (isSuperArgs(args)) {
            ...
            super(_abi, CrossMsgHelper__factory.linkBytecode(linkLibraryAddresses), signer);
        }
    }
...
exports.CrossMsgHelper__factory = CrossMsgHelper__factory;
CrossMsgHelper__factory.bytecode = _bytecode;
CrossMsgHelper__factory.abi = _abi;
//# sourceMappingURL=CrossMsgHelper__factory.js.map