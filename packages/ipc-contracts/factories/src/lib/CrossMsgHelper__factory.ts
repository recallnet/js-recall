...
export class CrossMsgHelper__factory extends ContractFactory {
  ...
  override connect(runner: ContractRunner | null): CrossMsgHelper__factory {
    return super.connect(runner) as CrossMsgHelper__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): CrossMsgHelperInterface {
    return new Interface(_abi) as CrossMsgHelperInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): CrossMsgHelper {
    return new Contract(address, _abi, runner) as unknown as CrossMsgHelper;
  }
}
