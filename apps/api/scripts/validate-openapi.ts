...
const testCases = [
  // === Simple Enum Schemas ===
  {
    name: "ActorStatus Schema",
    schema: "#/components/schemas/ActorStatus",
    data: "active",
  },
  {
    name: "CompetitionStatus Schema",
    schema: "#/components/schemas/CompetitionStatus",
    data: "active",
  },
  {
    name: "CompetitionType Schema",
    schema: "#/components/schemas/CompetitionType",
    data: "trading",
  },
  {
    name: "CrossChainTradingType Schema",
    schema: "#/components/schemas/CrossChainTradingType",
    data: "allow",
  },
  {
    name: "BlockchainType Schema",
    schema: "#/components/schemas/BlockchainType",
    data: "svm",
  },
  {
    name: "SpecificChain Schema",
    schema: "#/components/schemas/SpecificChain",
    data: "svm",
  },

  // === Simple Object Schemas ===
  {
    name: "SuccessResponse Schema",
  ...
  {
    name: "PortfolioTokenValue Schema",
    schema: "#/components/schemas/PortfolioTokenValue",
    data: {
  ...
  {
    name: "AgentMetadata Schema",
    schema: "#/components/schemas/AgentMetadata",
    data: {
      stats: {
      ...
      trophies: ["first_trade", "high_volume"],
      hasUnclaimedRewards: false,
    },
  },
  {
    name: "OwnerInfo Schema",
    schema: "#/components/schemas/OwnerInfo",
    data: {
  ...
  },
  {
    ...
    schema: "#/components/schemas/Competition",
    data: {
      id: "123e4567-e89b-12d3-a456-426614174003",
      name: "Q1 Trading Challenge",
      description: "A quarterly trading competition",
      type: "trading",
      externalUrl: "https://example.com/competition",
      imageUrl: "https://example.com/competition-banner.jpg",
      startDate: "2024-01-01T00:00:00Z",
      endDate: "2024-03-31T23:59:59Z",
      votingStartDate: "2024-04-01T00:00:00Z",
      votingEndDate: "2024-04-07T23:59:59Z",
      status: "active",
  ...
  {
    name: "AgentWithMetrics Schema",
    schema: "#/components/schemas/AgentWithMetrics",
    data: {
  ...
  {
    name: "AgentWithOwner Schema",
    schema: "#/components/schemas/AgentWithOwner",
    data: {
      id: "123e4567-e89b-12d3-a456-426614174000",
      ownerId: "123e4567-e89b-12d3-a456-426614174001",
      name: "Test Agent",
  ...
  {
    name: "EnhancedCompetition Schema",
    schema: "#/components/schemas/EnhancedCompetition",
    data: {
      id: "123e4567-e89b-12d3-a456-426614174003",
      name: "Q1 Trading Challenge",
      description: "A quarterly trading competition",
