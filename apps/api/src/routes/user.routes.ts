...
export function configureUserRoutes(
   ...
   *   post:
   *     summary: Claim all non-claimed rewards for the authenticated user
   *     description: |
   ...
   *                 claimedCount:
   *                   type: integer
   *                   description: Number of rewards that were claimed
   *                   example: 3
   *                 message:
   *                   type: string
   *                   description: Success message
   *                   example: "Successfully claimed 3 rewards"
   *       401:
   *         description: User not authenticated
   *         content:
   *           application/json:
   ...
   *                   example: "Internal server error"
   */
  router.post("/rewards/claim", rewardsController.claimAllRewards);
