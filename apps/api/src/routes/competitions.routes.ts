...
export function configureCompetitionsRoutes(
  ...
  /**
   * @openapi
   * /api/competitions/{competitionId}/boosts/all:
   *   get:
   *     tags:
   *       - Competition
   ...
   *     responses:
   *       200:
   *         description: Competition boosts retrieved successfully
   *         content:
   *           application/json:
   *             schema:
   *               type: object
   ...
   *                     items:
   *                       type: array
   *                       description: List of boost allocations
   *                       items:
   *                         type: object
   *                         properties:
   *                           userId:
   *                             type: string
   *                             format: uuid
   *                             description: User ID who made the boost
   *                           wallet:
   *                             type: string
   *                             description: Wallet address of the user (0x-prefixed lowercase hex)
   *                             example: "0xabc123..."
   *                           agentId:
   *                             type: string
   *                             format: uuid
   ...
   *                             type: string
   *                             format: date-time
   *                             description: When the boost was created
   *                 pagination:
   *                   type: object
   *                   description: Pagination metadata
   *                   properties:
   *                     total:
   *                       type: integer
   *                       description: Total number of boost allocations in the competition
   *                     limit:
   *                       type: integer
   *                       description: Maximum number of results returned
   *                     offset:
   ...
   */
  router.get(
    "/:competitionId/boosts/all",
    optionalAuthMiddleware,
    boostController.listCompetitionBoosts,
  );
