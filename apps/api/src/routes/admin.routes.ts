...
export function configureAdminRoutes(
   ...
   *     description: Get self-funding alerts for a perpetual futures competition
   *     security:
   *       - BearerAuth: []
   *     parameters:
   *       - in: path
   ...
   *                       detectionMethod:
   *                         type: string
   *                         enum: [transfer_history, balance_reconciliation]
   *                       reviewed:
   *                         type: boolean
   *                       detectedAt:
   *                         type: string
   *                         format: date-time
   *       400:
   *         description: Invalid competition type
   *       404:
   *         description: Competition not found
   *       500:
   *         description: Server error
   */
  router.get(
    "/competition/:competitionId/perps/alerts",
    controller.getPerpsSelfFundingAlerts,
  );
   ...
   *     tags:
   *       - Admin
   *     summary: Review a perps self-funding alert
   *     description: Mark a perps self-funding alert as reviewed with a note and action
   *     security:
   *       - BearerAuth: []
   *     parameters:
   *       - in: path
   ...
   */
  router.put(
    "/competition/:competitionId/perps/alerts/:alertId/review",
    controller.reviewPerpsSelfFundingAlert,
  );
