...
describe("ConvictionClaimsRepository", () => {
  ...
  test("saveConvictionClaim should save a new conviction claim", async () => {
    ...
    expect(savedClaims[0]!.amount).toBe(claimData.amount);
  ...
  test("getConvictionClaimsByAccount should return conviction claims for specific account", async () => {
    ...
    expect(account1Claims[0]!.amount).toBe(BigInt("1000000000000000000"));
    ...
    expect(account2Claims[0]!.amount).toBe(BigInt("2000000000000000000"));
  });
  ...
  test("getTotalConvictionClaimedByAccount should sum claimed amounts", async () => {
    ...
    expect(totalClaimed).toBe(BigInt("3500000000000000000"));
    ...
    expect(totalSeason0).toBe(BigInt("3500000000000000000"));
    ...
    expect(totalSeason1).toBe(BigInt(0));
  });
  ...
  test("getLatestConvictionClaim should return most recent conviction claim", async () => {
    ...
    expect(latestClaim!.claimedAmount).toBe(BigInt("1500000000000000000"));
