...
ALTER TABLE "sports"."competition_games" ADD CONSTRAINT "competition_games_game_id_fkey" FOREIGN KEY ("game_id") REFERENCES "sports"."nfl_games"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "sports"."nfl_game_plays" ADD CONSTRAINT "game_plays_game_id_fkey" FOREIGN KEY ("game_id") REFERENCES "sports"."nfl_games"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "sports"."game_prediction_scores" ADD CONSTRAINT "game_prediction_scores_game_id_fkey" FOREIGN KEY ("game_id") REFERENCES "sports"."nfl_games"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "sports"."game_predictions" ADD CONSTRAINT "game_predictions_game_id_fkey" FOREIGN KEY ("game_id") REFERENCES "sports"."nfl_games"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
