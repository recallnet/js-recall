...
ALTER TABLE "stakes" ADD COLUMN "wallet" varchar(42) NOT NULL;--> statement-breakpoint
...
CREATE INDEX "events_block_timestamp_idx" ON "indexing_events" USING btree ("block_timestamp");--> statement-breakpoint
CREATE INDEX "events_type_idx" ON "indexing_events" USING btree ("type");--> statement-breakpoint
...
CREATE INDEX "boost_balances_wallet_idx" ON "boost_balances" USING btree ("wallet");--> statement-breakpoint
