...
CREATE TABLE "competitions" (
	...
	"allow_cross_chain_trading" boolean DEFAULT false NOT NULL,
	"created_at" timestamp with time zone DEFAULT now(),
	"updated_at" timestamp with time zone DEFAULT now()
);
--> statement-breakpoint
...
CREATE INDEX "idx_balances_specific_chain" ON "balances" USING btree ("specific_chain");--> statement-breakpoint
CREATE INDEX "idx_balances_team_id" ON "balances" USING btree ("team_id");--> statement-breakpoint
CREATE INDEX "idx_competitions_status" ON "competitions" USING btree ("status");--> statement-breakpoint
CREATE INDEX "idx_portfolio_snapshots_team_competition" ON "portfolio_snapshots" USING btree ("team_id","competition_id");--> statement-breakpoint
CREATE INDEX "idx_portfolio_snapshots_timestamp" ON "portfolio_snapshots" USING btree ("timestamp");--> statement-breakpoint
CREATE INDEX "idx_portfolio_token_values_snapshot_id" ON "portfolio_token_values" USING btree ("portfolio_snapshot_id");--> statement-breakpoint
CREATE INDEX "idx_portfolio_token_values_specific_chain" ON "portfolio_token_values" USING btree ("specific_chain");--> statement-breakpoint
CREATE INDEX "idx_prices_chain" ON "prices" USING btree ("chain");--> statement-breakpoint
CREATE INDEX "idx_prices_specific_chain" ON "prices" USING btree ("specific_chain");--> statement-breakpoint
CREATE INDEX "idx_prices_timestamp" ON "prices" USING btree ("timestamp");--> statement-breakpoint
CREATE INDEX "idx_prices_token" ON "prices" USING btree ("token");--> statement-breakpoint
CREATE INDEX "idx_prices_token_chain" ON "prices" USING btree ("token","chain");--> statement-breakpoint
CREATE INDEX "idx_prices_token_specific_chain" ON "prices" USING btree ("token","specific_chain");--> statement-breakpoint
CREATE INDEX "idx_prices_token_timestamp" ON "prices" USING btree ("token","timestamp");--> statement-breakpoint
...
CREATE INDEX "idx_trades_competition_id" ON "trades" USING btree ("competition_id");--> statement-breakpoint
CREATE INDEX "idx_trades_from_chain" ON "trades" USING btree ("from_chain");--> statement-breakpoint
CREATE INDEX "idx_trades_from_specific_chain" ON "trades" USING btree ("from_specific_chain");--> statement-breakpoint
CREATE INDEX "idx_trades_team_id" ON "trades" USING btree ("team_id");--> statement-breakpoint
CREATE INDEX "idx_trades_timestamp" ON "trades" USING btree ("timestamp");--> statement-breakpoint
CREATE INDEX "idx_trades_to_chain" ON "trades" USING btree ("to_chain");--> statement-breakpoint
CREATE INDEX "idx_trades_to_specific_chain" ON "trades" USING btree ("to_specific_chain");