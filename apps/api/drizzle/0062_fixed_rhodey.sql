CREATE TABLE "boost_bonus" (
	...
	CONSTRAINT "boost_bonus_amount_check" CHECK ("amount" > 0)
);
...
ALTER TABLE "boost_bonus" ADD CONSTRAINT "boost_bonus_created_by_admin_id_admins_id_fk" FOREIGN KEY ("created_by_admin_id") REFERENCES "public"."admins"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "boost_bonus_user_active_idx" ON "boost_bonus" USING btree ("user_id","is_active","expires_at") WHERE "is_active" = true;--> statement-breakpoint
