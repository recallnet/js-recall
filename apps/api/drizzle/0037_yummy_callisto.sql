...
ALTER TABLE "boost_balances" ADD CONSTRAINT "boost_balances_competition_id_competitions_id_fk" FOREIGN KEY ("competition_id") REFERENCES "public"."competitions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "boost_changes" ADD CONSTRAINT "boost_changes_balance_id_boost_balances_id_fk" FOREIGN KEY ("balance_id") REFERENCES "public"."boost_balances"("id") ON DELETE restrict ON UPDATE cascade;--> statement-breakpoint
...
CREATE UNIQUE INDEX "boost_balances_wallet_competition_uniq" ON "boost_balances" USING btree ("wallet","competition_id");--> statement-breakpoint
CREATE INDEX "boost_balances_balance_desc_idx" ON "boost_balances" USING btree ("competition_id","balance" DESC);--> statement-breakpoint
...
CREATE UNIQUE INDEX "boost_changes_balance_idem_uq" ON "boost_changes" USING btree ("balance_id","idem_key");--> statement-breakpoint
CREATE INDEX "boost_changes_balance_created_idx" ON "boost_changes" USING btree ("balance_id","created_at" DESC);--> statement-breakpoint
