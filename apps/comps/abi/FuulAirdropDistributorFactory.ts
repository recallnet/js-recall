export const FuulAirdropDistributorFactoryABI = [
  ...
  { inputs: [], name: "InvalidDurationPenalty", type: "error" },
    ...
    inputs: [
      {
        components: [
          ...
          },
          {
            ...
            internalType:
              "struct IFuulAirdropDistributorFactory.DurationPenalty[]",
            name: "durationPenalty",
            type: "tuple[]",
          },
        ],
        internalType: "struct IFuulAirdropDistributorFactory.DistributorInitParams",
        name: "params",
        type: "tuple",
      },
    ],
