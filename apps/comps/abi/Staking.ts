export const StakingAbi = [
  ...
  {
    inputs: [],
    name: "MaxWithdrawCooldown",
    type: "error",
  },
  {
    inputs: [],
    name: "NonPartialUnstake",
    type: "error",
  },
  {
    inputs: [
  ...
  {
    inputs: [],
    name: "TooEarlyForRelock",
    type: "error",
  },
  {
    inputs: [],
    name: "TooEarlyForUnstake",
    type: "error",
  },
  {
    inputs: [],
    ...
    inputs: [
      {
        indexed: false,
        internalType: "uint256",
        name: "newWithdrawCooldown",
        type: "uint256",
      },
    ],
    name: "UpdateWithdrawCooldown",
    type: "event",
  },
  {
    anonymous: false,
    ...
    outputs: [
      {
        ...
        internalType: "struct IStaking.StakeInfoWithId[]",
        name: "",
        type: "tuple[]",
      },
    ],
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "contract INftReceipt",
        name: "",
        type: "address",
      },
    ],
