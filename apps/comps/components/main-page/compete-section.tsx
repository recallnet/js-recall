      ...
      <div className="max-w-5xl mx-auto flex flex-col items-center">
        ...
        >
          ...
          {categories.map((cat) => (
            ...
            >
              <Card corner='bottom-left' cropSize={45} className="flex-1 bg-gray-800 h-60 rounded-xl shadow-md flex items-center justify-center">
                <div className="flex h-full">
                  <div className="border-r border-gray-500 flex justify-center items-end pb-10 pl-10 w-2/3">
