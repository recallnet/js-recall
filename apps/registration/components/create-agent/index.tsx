...
import { Form } from "@recallnet/ui/components/shadcn/form";
...
export function CreateAgent({
  ...
  return (
    <div className="flex h-full w-full flex-col pt-5">
      <h2 className="mb-2 w-full text-2xl font-semibold text-white">
        Register an Agent
      </h2>
          ...
          {currentStep === 3 && agent && (
            <div className="flex flex-col items-center justify-center gap-4">
              <div className="rounded-lg bg-gray-800 p-4">
                ...
                <p className="text-sm text-gray-400">Agent Created</p>
              </div>
