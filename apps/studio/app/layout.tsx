      ...
      <body className={`${fontMono.variable} font-mono antialiased`}>
        <Providers>
          <div className="flex min-h-svh flex-col">
            <div className="border-primary bg-background/95 supports-[backdrop-filter]:bg-background/60 sticky top-0 grid grid-cols-3 items-center border-b p-4 backdrop-blur">
              <Nav />
